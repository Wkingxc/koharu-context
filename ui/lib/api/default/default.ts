...
import type {
  ...
  ConfigPatch,
  ContinueChapterTranslationRequest,
...
>(
  ...
  return {
    queryKey,
    queryFn,
    enabled: hash !== null && hash !== undefined,
    gcTime: 300000,
    retry: 1,
    ...queryOptions,
...
export const getStartChapterTranslationUrl = () => {
  return `/api/v1/chapter-translations`
}

export const startChapterTranslation = async (
  startChapterTranslationRequest: StartChapterTranslationRequest,
  options?: RequestInit,
): Promise<StartChapterTranslationResponse> => {
  return fetchApi<StartChapterTranslationResponse>(getStartChapterTranslationUrl(), {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(startChapterTranslationRequest),
  })
}

export const getStartChapterTranslationMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof startChapterTranslation>>,
    TError,
    { data: StartChapterTranslationRequest },
    TContext
  >
  request?: SecondParameter<typeof fetchApi>
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ['startChapterTranslation']
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
  ...
  > = (props) => {
    ...
    return startChapterTranslation(data, requestOptions)
  }

  return { mutationFn, ...mutationOptions }
}

export type StartChapterTranslationMutationResult = NonNullable<
  Awaited<ReturnType<typeof startChapterTranslation>>
>
export type StartChapterTranslationMutationBody = StartChapterTranslationRequest
export type StartChapterTranslationMutationError = unknown

export const useStartChapterTranslation = <TError = unknown, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof startChapterTranslation>>,
      TError,
  ...
  TContext
> => {
  return useMutation(getStartChapterTranslationMutationOptions(options), queryClient)
}
export const getContinueChapterTranslationUrl = (id: string) => {
  return `/api/v1/chapter-translations/${id}/continue`
}

export const continueChapterTranslation = async (
  id: string,
  continueChapterTranslationRequest: ContinueChapterTranslationRequest,
  options?: RequestInit,
): Promise<void> => {
  return fetchApi<void>(getContinueChapterTranslationUrl(id), {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(continueChapterTranslationRequest),
  })
}

export const getContinueChapterTranslationMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof continueChapterTranslation>>,
    TError,
    { id: string; data: ContinueChapterTranslationRequest },
    TContext
  >
  request?: SecondParameter<typeof fetchApi>
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ['continueChapterTranslation']
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
  ...
  > = (props) => {
    ...
    return continueChapterTranslation(id, data, requestOptions)
  }

  return { mutationFn, ...mutationOptions }
}

export type ContinueChapterTranslationMutationResult = NonNullable<
  Awaited<ReturnType<typeof continueChapterTranslation>>
>
export type ContinueChapterTranslationMutationBody = ContinueChapterTranslationRequest
export type ContinueChapterTranslationMutationError = unknown

export const useContinueChapterTranslation = <TError = unknown, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof continueChapterTranslation>>,
      TError,
  ...
  TContext
> => {
  return useMutation(getContinueChapterTranslationMutationOptions(options), queryClient)
}
export const getRetryChapterTranslationUrl = (id: string) => {
  return `/api/v1/chapter-translations/${id}/retry`
}
...
export const getRetryChapterTranslationMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
>(
  ...
  return {
    queryKey,
    queryFn,
    enabled: family !== null && family !== undefined && file !== null && file !== undefined,
    gcTime: 300000,
    retry: 1,
    ...queryOptions,
...
> => {
  ...
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof importProject>>, { data?: Blob }> = (
    props,
  ) => {
    const { data } = props ?? {}
