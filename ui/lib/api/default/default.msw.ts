...
export const getStartChapterTranslationResponseMock = (
  overrideResponse: Partial<Extract<StartChapterTranslationResponse, object>> = {},
): StartChapterTranslationResponse => ({
  operationId: faker.string.alpha({ length: { min: 10, max: 20 } }),
  ...overrideResponse,
})

export const getRetryChapterTranslationResponseMock = (
  overrideResponse: Partial<Extract<StartChapterTranslationResponse, object>> = {},
): StartChapterTranslationResponse => ({
  operationId: faker.string.alpha({ length: { min: 10, max: 20 } }),
  ...overrideResponse,
...
export const getEventsResponsePipelineProgressMock = (
  overrideResponse: Partial<PipelineProgress> = {},
): PipelineProgress => ({
  ...{
    awaitingBatchReview: faker.helpers.arrayElement([faker.datatype.boolean(), undefined]),
    batchSummaries: faker.helpers.arrayElement([
      Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() =>
        faker.string.alpha({ length: { min: 10, max: 20 } }),
      ),
      undefined,
    ]),
    batchSummary: faker.helpers.arrayElement([
      faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), null]),
      undefined,
    ]),
    chapterPhase: faker.helpers.arrayElement([
      faker.helpers.arrayElement([
        null,
        faker.helpers.arrayElement(Object.values(ChapterTranslationPhase)),
      ]),
      undefined,
    ]),
    chapterTotalPages: faker.helpers.arrayElement([
      faker.helpers.arrayElement([faker.number.int({ min: 0 }), null]),
      undefined,
    ]),
    currentBatch: faker.helpers.arrayElement([
      faker.helpers.arrayElement([faker.number.int({ min: 0 }), null]),
      undefined,
    ]),
    ...
    preparedPages: faker.helpers.arrayElement([
      faker.helpers.arrayElement([faker.number.int({ min: 0 }), null]),
      undefined,
    ]),
    renderedPages: faker.helpers.arrayElement([
      faker.helpers.arrayElement([faker.number.int({ min: 0 }), null]),
      undefined,
    ]),
    status: faker.helpers.arrayElement([
    ...
    step: faker.helpers.arrayElement([
      faker.helpers.arrayElement([null, faker.helpers.arrayElement(Object.values(PipelineStep))]),
      undefined,
    ]),
    totalBatches: faker.helpers.arrayElement([
      faker.helpers.arrayElement([faker.number.int({ min: 0 }), null]),
      undefined,
    ]),
    totalPages: faker.number.int({ min: 0 }),
    totalSteps: faker.number.int({ min: 0 }),
    translatedPages: faker.helpers.arrayElement([
      faker.helpers.arrayElement([faker.number.int({ min: 0 }), null]),
      undefined,
    ]),
  },
        ...
        jobs: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(
          () => ({
            ...
            progress: faker.helpers.arrayElement([
              faker.helpers.arrayElement([null, { ...getEventsResponsePipelineProgressMock() }]),
              undefined,
            ]),
            status: faker.helpers.arrayElement(Object.values(JobStatus)),
          }),
...
export const getListOperationsResponsePipelineProgressMock = (
  overrideResponse: Partial<PipelineProgress> = {},
): PipelineProgress => ({
  ...{
    awaitingBatchReview: faker.helpers.arrayElement([faker.datatype.boolean(), undefined]),
...
export const getListOperationsResponseMock = (
  ...
  operations: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(
    () => ({
      ...
      kind: faker.string.alpha({ length: { min: 10, max: 20 } }),
      progress: faker.helpers.arrayElement([
        faker.helpers.arrayElement([null, { ...getListOperationsResponsePipelineProgressMock() }]),
        undefined,
      ]),
      status: faker.helpers.arrayElement(Object.values(JobStatus)),
    }),
...
export const getStartChapterTranslationMockHandler = (
  overrideResponse?:
    | StartChapterTranslationResponse
    | ((
        info: Parameters<Parameters<typeof http.post>[1]>[0],
      ) => Promise<StartChapterTranslationResponse> | StartChapterTranslationResponse),
  options?: RequestHandlerOptions,
) => {
  return http.post(
      ...
      return HttpResponse.json(
        overrideResponse !== undefined
          ? typeof overrideResponse === 'function'
            ? await overrideResponse(info)
            : overrideResponse
          : getStartChapterTranslationResponseMock(),
        { status: 200 },
      )
    },
    options,
...
export const getContinueChapterTranslationMockHandler = (
  overrideResponse?:
    | void
  ...
  return http.post(
    '*/chapter-translations/:id/continue',
    async (info: Parameters<Parameters<typeof http.post>[1]>[0]) => {
      if (typeof overrideResponse === 'function') {
        await overrideResponse(info)
      }
...
export const getRetryChapterTranslationMockHandler = (
  overrideResponse?:
    | StartChapterTranslationResponse
    | ((
        info: Parameters<Parameters<typeof http.post>[1]>[0],
      ...
      return HttpResponse.json(
        overrideResponse !== undefined
          ? typeof overrideResponse === 'function'
            ? await overrideResponse(info)
            : overrideResponse
          : getRetryChapterTranslationResponseMock(),
        { status: 200 },
      )
    },
    options,
...
export const getDefaultMock = () => [
  ...
  getStartChapterTranslationMockHandler(),
  getContinueChapterTranslationMockHandler(),
  getRetryChapterTranslationMockHandler(),
